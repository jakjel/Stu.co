package org.s3.individualassignment.backend.configuration.security.isAuthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(org.s3.individualassignment.backend.configuration.security.isAuthenticated.IsAuthenticated1)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(org.s3.individualassignment.backend.configuration.security.isAuthenticated.IsAuthenticated1)")
